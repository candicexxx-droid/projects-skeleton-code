...
class StatementDataset(torch.utils.data.Dataset):#inherit from torch.utils.data.Dataset to make our life easier in dealing with Data
    ...
    def __getitem__(self, index):  #retrieve items from our dataset 
        ...
        path ='/Users/candicecai/Desktop/Sophomore-Spring-ACM-AI-Project/cassava-leaf-disease-classification/train_images/'
...
def StartingDataset():
    #change the path
    image_info = pd.read_csv((r'/Users/candicecai/Desktop/Sophomore-Spring-ACM-AI-Project/cassava-leaf-disease-classification/train.csv'))
